...
exports.testEncodeReturnsBuffer = function(test){
	...
	const c = this.g._encodePacket(packet_types.CAN_DO, new Buffer('some data'), 'ascii');
	test.ok(Buffer.isBuffer(c), 'passing buffer payload fails');

	const d = this.g._encodePacket(packet_types.CAN_DO, new Buffer(''), 'ascii');
...
exports.testCAN_DO = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,1,0,0,0,13, 0x74, 0x65, 0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e]);
...
exports.testCANT_DO = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,2,0,0,0,13, 0x74, 0x65, 0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e]);
...
exports.testRESET_ABILITIES = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,3,0,0,0,0]);
...
exports.testPRE_SLEEP = function(test){
	...
	const data = new Buffer([0,0x52,0x45,0x51,0,0,0,4,0,0,0,0]);
...
exports.testSUBMIT_JOB = function(test){
	...
	let unique_id = '';
	const payload = new Buffer('test payload');
	const payload2 = put().
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,7,0,0,0, 0x1b, 0x74, 0x65, 
...
exports.testGRAB_JOB = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,9,0,0,0,0]);
...
exports.testWORK_STATUS = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 12, 0, 0, 0, 21, 0x74, 0x65,
...
exports.testWORK_COMPLETE = function(test){
	const job_handle = new Buffer('test job handle', 'ascii');
	let payload = new Buffer('test work result', 'ascii');
	payload = put().
		put(job_handle).
		word8(0).
		put(payload).
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 13, 0, 0, 0, 32, 0x74, 0x65,
  0x73, 0x74, 0x20, 0x6a, 0x6f, 0x62, 0x20, 0x68, 0x61, 0x6e, 0x64, 0x6c, 
...
exports.testWORK_FAIL = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 14, 0, 0, 0, 15, 0x74, 0x65,
...
exports.testSUBMIT_JOB_BG = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,18,0,0,0, 0x1b, 0x74, 0x65, 
  	0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x00,
  	 0x00, 0x74, 0x65, 0x73, 0x74, 0x20, 0x70, 0x61, 0x79, 0x6c, 0x6f, 
  	 0x61, 0x64]);
...
exports.testSUBMIT_JOB_HIGH = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,21,0,0,0, 0x1b, 0x74, 0x65, 
  	0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x00,
  	 0x00, 0x74, 0x65, 0x73, 0x74, 0x20, 0x70, 0x61, 0x79, 0x6c, 0x6f, 
  	 0x61, 0x64]);
...
exports.testSET_CLIENT_ID = function(test){
	const payload = new Buffer('test client id', 'ascii');
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 22, 0, 0, 0, 14, 0x74, 0x65,
...
exports.testCAN_DO_TIMEOUT = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 23, 0, 0, 0, 18, 0x74, 0x65,
   0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x00, 
   0x00, 0x00, 0x07, 0xd0 ]);
...
exports.testALL_YOURS = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,24,0,0,0,0]);
...
exports.testWORK_EXCEPTION = function(test){
	const job_handle = new Buffer('test job handle', 'ascii');
	const exception = new Buffer('test job handle', 'ascii');
	const payload = put().
		put(job_handle).
		word8(0).
		put(exception).
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 25, 0, 0, 0, 31, 0x74, 0x65,
   0x73, 0x74, 0x20, 0x6a, 0x6f, 0x62, 0x20, 0x68, 0x61, 0x6e, 0x64, 0x6c, 
...
exports.testWORK_DATA = function(test){
	const job_handle = new Buffer('test job handle', 'ascii');
	let payload = new Buffer('partial work', 'ascii');
	payload = put().
		put(job_handle).
		word8(0).
		put(payload).
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 28, 0, 0, 0, 28, 0x74, 0x65,
   0x73, 0x74, 0x20, 0x6a, 0x6f, 0x62, 0x20, 0x68, 0x61, 0x6e, 0x64, 0x6c, 
...
exports.testWORK_WARNING = function(test){
	const job_handle = new Buffer('test job handle', 'ascii');
	const warning = new Buffer('test warning', 'ascii');
	const payload = put().
		put(job_handle).
		word8(0).
		put(warning).
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 29, 0, 0, 0, 28, 0x74, 0x65,
   0x73, 0x74, 0x20, 0x6a, 0x6f, 0x62, 0x20, 0x68, 0x61, 0x6e, 0x64, 0x6c, 
...
exports.testGRAB_JOB_UNIQ = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0, 30, 0, 0, 0, 0 ]);
...
exports.testSUBMIT_JOB_HIGH_BG = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,32,0,0,0, 0x1b, 0x74, 0x65, 
  	0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x00,
  	 0x00, 0x74, 0x65, 0x73, 0x74, 0x20, 0x70, 0x61, 0x79, 0x6c, 0x6f, 
  	 0x61, 0x64]);
...
exports.testSUBMIT_JOB_LOW = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,33,0,0,0, 0x1b, 0x74, 0x65, 
  	0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x00,
  	 0x00, 0x74, 0x65, 0x73, 0x74, 0x20, 0x70, 0x61, 0x79, 0x6c, 0x6f, 
  	 0x61, 0x64]);
...
exports.testSUBMIT_JOB_LOW_BG = function(test){
  ...
  const data = new Buffer([0,0x52,0x45,0x51,0,0,0,34,0,0,0, 0x1b, 0x74, 0x65, 
  	0x73, 0x74, 0x20, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x00,
  	 0x00, 0x74, 0x65, 0x73, 0x74, 0x20, 0x70, 0x61, 0x79, 0x6c, 0x6f, 
  	 0x61, 0x64]);
