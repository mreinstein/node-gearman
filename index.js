...
(function() {
  'use strict';
  var EventEmitter, Gearman, GearmanPacketFactory, binary, debug, e, error1, nb, net, packet_types, put, req, req_magic, res_magic,
    ...
    function Gearman(host, port, options) {
      ...
      this._conn.on('data', (function(_this) {
        return function(chunk) {
          var j, len1, packet, packets, results;
          packets = _this._packetFactory.addBytes(chunk);
          results = [];
          for (j = 0, len1 = packets.length; j < len1; j++) {
            packet = packets[j];
            results.push(_this._handlePacket(_this._decodePacket(packet)));
          }
          return results;
        };
      })(this));
